"""
Django settings for together_project project.
...
SECRET_KEY = 'skhy4@5mmms5k^(ihkiq^%+y$d=7x=wlsmwbh#wxpjh^2&!n26'
...
ROOT_URLCONF = 'together_project.urls'
...
WSGI_APPLICATION = 'together_project.wsgi.application'
